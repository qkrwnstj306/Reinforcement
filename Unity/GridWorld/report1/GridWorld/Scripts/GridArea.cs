...
public class GridArea : MonoBehaviour
{
    ...
    public int numberOfPlus = 10;
    public int numberOfEx = 10;
    public float grid_size = 15f;
    GameObject m_Plane;
    GameObject m_Sn;
    GameObject m_Ss;
    GameObject m_Se;
    ...
    void SetEnvironment()
    {
        transform.position = m_InitialPosition * (m_ResetParams.GetWithDefault("gridSize", grid_size) + 1);
        ...
        var gridSize = (int)m_ResetParams.GetWithDefault("gridSize", grid_size);
    ...
    {
        var gridSize = (int)m_ResetParams.GetWithDefault("gridSize", grid_size); // 현재 5 by 5
