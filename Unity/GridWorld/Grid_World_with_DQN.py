...
batch_size = 32 # 32 
mem_maxlen = 10000 #  10000
discount_factor = 0.9 # 0.9
learning_rate = 0.00025 # 

run_step = 50000 if train_mode else 0 # 50000
test_step = 5000
train_start_step = 5000  # 5000
target_update_step = 500 # 500
...
# 유니티 환경 경로 
game = "practice_GridWorld_8_by_8.x86_64"  # or practice_GridWorld_15_by_15.x86_64
...
save_path = f"/home/qkrwnstj/ml-agents/Project/saved_models/{game}/DQN/original123123"
load_path = f"/home/qkrwnstj/ml-agents/Project/saved_models/{game}/DQN/experiment6"
...
class DQNAgent:
    ...
    def train_model(self, step):
        ...
        #self.epsilon = max(epsilon_min, 1 - math.exp(3*(step/explore_step)-3))
        #self.epsilon = max(epsilon_min, 1 - math.log10(9*(step/explore_step)+1))
        ...
        if done:
            ...
            if episode % print_interval == 0:
                ...
                print(f"{episode} Episode / Step: {step} / Score: {mean_score:.2f} / " +\
                      f"Loss: {mean_loss} / Epsilon: {agent.epsilon:.4f}")
